<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="购票数量" align="center" prop="count"  width="150" />
      <el-table-column label="座位" align="center" prop="seat"  width="150" />
      <el-table-column label="总价/元" align="center" prop="totalPrice"  width="150" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="购票数量" prop="count">
          <el-input v-model.number="form.count" placeholder="请输入购票数量" />
        </el-form-item>
        <el-form-item label="座位" prop="seat">
          <el-input v-model="form.seat" placeholder="请输入座位例:5,6,7" />
        </el-form-item>
        <el-form-item label="总价" prop="totalPrice">
          <el-input v-model="form.totalPrice" placeholder="请输入座位例:5,6,7" />
        </el-form-item>
      </el-form>
...
<script>
import { listOrder, getOrder, delOrder, addOrder, updateOrder } from "@/api/film/order";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('film/order/export', {
        ...this.queryParams
